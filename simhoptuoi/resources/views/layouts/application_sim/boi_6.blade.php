    ...
    <section class="contentPage luanSim">
        ...
        <div class="bodyPage bodyLuanSim boi_sim_inputs">
            <section class="boxFormSim">
                <div class="bgFormSim">
                    <form novalidate name="form_xpts" action="{{ route('boi-sim-6-so') }}" method="post" accept-charset="UTF-8">
                        @csrf
                        <div style="display:none"></div>
                        <div class="row">
                            <input class="form-control" type="text" id="sinh_menh_input" name="sinh_menh_input" hidden>
