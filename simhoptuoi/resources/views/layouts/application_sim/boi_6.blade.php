...
@section('title', 'Bói sim 6 so cuoi')
    ...
    <section class="contentPage luanSim">
        ...
        <div class="bodyPage bodyLuanSim boi_sim_inputs">
            <section class="boxFormSim">
                <div class="bgFormSim">
                    <form novalidate id="form_xpts" name="form_xpts" action="{{ route('boi-sim-6-so') }}" method="post" accept-charset="UTF-8">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-9 col-md-9 col-sm-9 col-xs-9">
                                <input id="xpts_phone" class="myinput" name="sdt" placeholder="Mời nhập số sim" value="@if(!empty($sdt)) {{$sdt}} @endif">
                                @error('sdt')
