...
<div class="support">
    <div class="row">
        ...
        <div class="col-6 support-mess p-0">
            <a id="support-mess" target="_blank" href="https://m.me/boisimkinhdich141345"><img
                    src="{{ asset('common/templates/site/images/support/sp_messenger.png')}}"
                    alt="sp_messenger"></a>
        </div>
        <div class="col-6 support-delete p-0">
            <img src="{{ asset('common/templates/site/images/support/sp_deleteall.png')}}" alt="sp_deleteall">
        </div>
