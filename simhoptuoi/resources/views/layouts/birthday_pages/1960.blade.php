...
@section('content')
    <section class="contentPage">
        <h1 class="title_h1">Sim hợp tuổi Canh Tý 1960</h1>

        <input type="hidden" name="url_string" value="sim-hop-tuoi-canh-ty-1960/214">
          <div class="bodyPage">
            <div class="siteBodyContent">
                <div class="row">
                    <div class="col-md-12">
                        <h2 dir="ltr" style="text-align: justify; margin-bottom: 1.3em; border-bottom: 2px solid rgb(22, 51, 87);"><span style="font-size:16px"><span style="font-family:times new roman,times,serif"><span style="color:#FF0000"><strong><span id="1-sim-hop-tuoi-1960-va-nguyen-ly-chon-loc">1. Sim hợp tuổi 1960 và nguyên lý chọn lọc:</span></strong></span></span></span></h2>
                        ...
                        <p dir="ltr" style="text-align:justify"><span style="font-size:16px"><span style="font-family:times new roman,times,serif">Mỗi người sinh ra có năm sinh thuộc hành mệnh nhất định. Kim - Mộc - Thủy - Hỏa -Thổ. Người tuổi 1960 có năm sinh thuộc mệnh Thổ, chọn sim hợp tuổi 1960 ắt chọn sim hợp mệnh Thổ. Số điện thoại hợp mệnh Thổ sẽ ẩn chứa nguồn năng lượng mệnh Thổ sinh khí dồi dào, vạn sự hanh thông, cát lợi. </span></span></p>



                        <p dir="ltr" style="text-align:justify"><span style="font-size:16px"><span style="font-family:times new roman,times,serif">Gốc ngọn của vinh - nhục, sinh - diệt, thành - bại của nhân gian đều do quan hệ bổn trạch Âm - Dương sinh xuất, khắc nhập để phát sinh, biến hóa. Dương là tích cực, cứng cỏi, nhiệt liệt. Âm là lạnh nhạt, là nhu nhược,... Hai thế lực này tác động lẫn nhau tạo những lợi ích cho con người. Bởi thế cân bằng bản mệnh với dãy sim là tất yếu không thể bỏ qua. Tuổi 1960 Dương mạng nên sim hợp tuổi 1960 phải hòa hợp với Dương mạng của người tuổi này. Dãy sim càng vượng Âm càng tốt. Hợp mệnh khi kết hợp cân bằng tất thảy sẽ là nền tảng vững chắc giúp hành động luôn được bổ trợ từ kế hoạch tới thành công cuối cùng.</span></span></p>

                        <p dir="ltr" style="text-align:justify"><span style="font-size:16px"><span style="font-family:times new roman,times,serif">Dưới đây là danh sách <strong>sim điện thoại hợp tuổi 1960</strong> tổ hợp đầy đủ những yếu tố tiên quyết tích vượng khí đương vận trên cho người sinh năm 1960. Không mất nhiều công sức luận giải sim phức tạp, với danh sách sim này việc lựa chọn dãy sim hợp tuổi, hợp mệnh 1960 như ý muốn hoàn toàn nằm trong tầm tay bạn.</span></span></p>

                        <h2 style="text-align: justify; margin-bottom: 1.3em; border-bottom: 2px solid rgb(22, 51, 87);"><br>
                            <span style="font-size:16px"><span style="font-family:times new roman,times,serif"><span style="color:#FF0000"><strong><span id="2-tra-cuu-sim-phong-thuy-hop-tuoi-canh-ty-1960-">2. Tra cứu&nbsp;sim phong thủy hợp tuổi Canh Tý (1960):</span></strong></span></span></span></h2>



                        <p style="text-align:justify"><span style="font-size:16px"><span style="font-family:times new roman,times,serif"><span style="color:#000000">Xin mời nhập các thông tin về chi tiết về giờ ngày tháng năm sinh tại box tra dưới đây và tra cứu để nhận kết quả:</span></span></span></p>                    </div>
                </div>
            </div>
        </div>
        ...
        <p class="h3 text-center">Bảng sim hợp tuổi 1960</p>
            ...
            <div class="siteBodyContent">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <p><span style="font-size:16px"><span style="font-family:times new roman,times,serif">Bạn đã thử qua công cụ trực tuyến nào để kiểm tra sim – số điện thoại bạn đang dùng có hợp tuổi, hợp mệnh với mình chưa. Rất đơn giản và nhanh chóng, chỉ với một vài thao tác, bạn có thể có ngay kết quả về con số hợp tuổi 1960, số điện thoại hợp với tuổi Canh Tý cũng như những tuổi khác là bao nhiêu điểm. Cùng tham khảo cách mà <em>{{ $nameSite }} </em> đưa dưới đây nhé.</span></span></p>



                        <h3><strong><span style="font-size:16px"><span style="font-family:times new roman,times,serif">·Cách kiểm tra Sim – Số điện thoại bạn đang dùng có hợp tuổi 1960 không?</span></span></strong></h3>
                        ...
                        <h3><strong><span style="font-size:16px"><span style="font-family:times new roman,times,serif">·Chọn sim hợp tuổi Canh Tý 1960</span></span></strong></h3>
